...
@section('backend-main')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('dashboard.banner') }} {{ __('dashboard.banner') }} " {{ $slider->title_en }} "</h4>
                    ...
                    <form method="post" action="{{ route('category_sliders.update' , $slider->id) }}" class="needs-validation" novalidate
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subtitle_ar" class="form-control" id="subtitle_ar" placeholder="{{ __('dashboard.subtitle_ar') }}" value="{{ $slider->subtitle_ar }}" required>
                                    @error('subtitle_ar')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subtitle_en" class="form-control" id="subtitle_en" placeholder="{{ __('dashboard.subtitle_en') }}" value="{{ $slider->subtitle_en }}" required>
                                    @error('subtitle_en')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="validationCustom03">{{ __('dashboard.category') }} ({{ __('dashboard.optional') }})</label>
