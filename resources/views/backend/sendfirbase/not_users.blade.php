            ...
            <div class="col-md-12">
                ...
                <div class="card">
                        <div class="card-header">
                            @if(app()->getLocale() == 'en')
                                Send to Devices Without Registered Users
                            @else
                                ارسال الى الهواتف بدون اعضاء مسجلة
                            @endif
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('send_push_not_users') }}" class="needs-validation" novalidate
