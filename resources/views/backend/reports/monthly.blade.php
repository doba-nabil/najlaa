...
@section('backend-head')
    ...
    <link href="{{ asset('backend') }}/assets/libs/datatables.net-select-bs4/css/select.bootstrap4.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="{{ asset('backend') }}/yearpicker.css"
          rel="stylesheet" type="text/css"/>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('monthly_report_post') }}" class="needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="year" min="1999" class="form-control yearpicker" id="year" placeholder="@if(app()->getLocale() == 'en')
                                            Year
                                        @else
                                            السنة
                                        @endif" value="{{ old('year') }}" required>
                                    @error('year')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="month" class="form-control " id="validationCustom03">
...
@section('backend-footer')
    ...
    <script src="{{ asset('backend') }}/yearpicker.js"></script>
    <script>
        $(function() {
